...
class ResendRequest(BaseModel):
    ...
    channel: Optional[Channel] = Field(default=None, description="Move this OTP onto a specific channel, e.g. \"sms\" when the recipient has no WhatsApp. The channel must be enabled for your app and the recipient. Omit to advance to the next channel in your routing order.")
