...
class ResendRequest(BaseModel):
    ...
    """ # noqa: E501
    otp_id: UUID
    channel: Optional[StrictStr] = Field(default=None, description="Move this OTP onto a specific channel, e.g. \"sms\" when the recipient has no WhatsApp. The channel must be enabled for your app and the recipient. Omit to advance to the next channel in your routing order. ")
    ...
    def channel_validate_enum(cls, value):
        ...
        if value not in set(['sms', 'whatsapp', 'email', 'telegram']):
            raise ValueError("must be one of enum values ('sms', 'whatsapp', 'email', 'telegram')")
        return value
