...
class OtpResponse(BaseModel):
    ...
    masked_recipient: StrictStr = Field(description="Recipient with the middle masked, e.g. +14****71.")
    action_url: Optional[StrictStr] = Field(default=None, description="WhatsApp link the user opens to receive the code: they send us the prefilled message and we reply with the code over WhatsApp. Present only when the OTP was dispatched on the whatsapp channel; null otherwise. Verification is the same on every channel: the user enters the code and you call `/otp/verify`. ", json_schema_extra={"examples": ["https://wa.me/13845555555?text=Verify%20me%3A%20aB3xZ-9kQ2m-7pLw4-2mN8k"]})
