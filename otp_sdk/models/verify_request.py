...
class VerifyRequest(BaseModel):
    ...
    VerifyRequest
    """ # noqa: E501
    otp_id: UUID = Field(description="The OTP id returned by send/resend.")
    code: Annotated[str, Field(min_length=1, strict=True, max_length=16)] = Field(description="The code the recipient entered.", json_schema_extra={"examples": ["123456"]})
    __properties: ClassVar[List[str]] = ["otp_id", "code"]
