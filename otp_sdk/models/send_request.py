...
class SendRequest(BaseModel):
    ...
    SendRequest
    """ # noqa: E501
    recipient: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Phone number in E.164 (e.g. +14155552671) or an email address.")
    locale: Optional[StrictStr] = Field(default=None, description="Message language, e.g. \"en\" or \"tr\".")
