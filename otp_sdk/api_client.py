...
from otp_sdk.configuration import Configuration
from otp_sdk.api_response import ApiResponse, T as ApiResponseT
import otp_sdk.models
from otp_sdk import rest
from otp_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(otp_sdk.models, klass)
