...
class TestOtpStatusResponse(unittest.TestCase):
    """OtpStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OtpStatusResponse:
        """Test OtpStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OtpStatusResponse`
        """
        model = OtpStatusResponse()
        if include_optional:
    ...
    def testOtpStatusResponse(self):
        """Test OtpStatusResponse"""
